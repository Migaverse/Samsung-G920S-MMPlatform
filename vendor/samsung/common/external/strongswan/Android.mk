...
# strongSwan use boringssl 
ifneq (,$(wildcard external/boringssl/flavor.mk))
openssl_PATH := external/boringssl/include
openssl_crypto_PATH := external/boringssl/src
else
openssl_PATH := external/crypto-fips/include
endif
...
# seems that DCM also needs FRAGMENTATION_YES option, so disabled FORCE_FRAGMENT_CONF
