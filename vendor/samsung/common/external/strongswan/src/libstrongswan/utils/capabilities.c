...
#ifndef WIN32
  /* 
     In Android we are following Android 
     security model. Hence, we do not touch
     capabilities or groups in here. Caps and
     groups are defined in the init.rc. 
     (The exception is that we do setuid here. 
     It would be nice to set it also in the
     init.rc. But oh well, world is not perfect...
  */
