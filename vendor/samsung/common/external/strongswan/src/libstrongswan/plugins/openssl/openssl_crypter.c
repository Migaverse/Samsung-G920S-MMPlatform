												  ...
												  size_t key_size)
{
	...
	switch (algo)
	{
		...
		case ENCR_AES_CBC:
			switch (key_size)
			{
				...
				case 16:        /* AES 128 */
					...
					break;
				case 24:        /* AES-192 is not supported in BoringSSL */
					DBG1(DBG_LIB, "BoringSSL does not support AES_CBC_192");
					free(this);
					return NULL;
				case 32:        /* AES-256 */
		...
		case ENCR_CAMELLIA_CBC:
			...
			break;
		case ENCR_3DES:       /* 3DES-CBC */
			key_size = 24;
			this->cipher = EVP_get_cipherbyname("3des-cbc");
			break;
		...
		case ENCR_DES_ECB:
			 ...
			 * ENCR_DES_ECB is not supported in BoringSSL, make this fall through.
			 */
			DBG1(DBG_LIB, "BoringSSL does not support DES_ECB");
			free(this);
			return NULL;
#else
			key_size = 8;
