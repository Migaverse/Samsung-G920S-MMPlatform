...
LOCAL_C_INCLUDES += $(openssl_crypto_PATH)
LOCAL_SHARED_LIBRARIES += libcrypto
else
LOCAL_SHARED_LIBRARIES += libfips_crypto
endif
...
ifneq ($(call plugin_enabled, kernel-libipsec),)
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../libipsec/
LOCAL_STATIC_LIBRARIES += libstrongswanipsec
endif
...
LOCAL_SRC_FILES += $(call add_plugin, unity)
