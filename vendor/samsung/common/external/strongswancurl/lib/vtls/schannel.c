...
#include "lib/curl_sspi.h"
#include "schannel.h"
#include "vtls.h"
#include "lib/sendf.h"
#include "lib/connect.h" /* for the connect timeout */
#include "lib/strerror.h"
#include "lib/select.h" /* for the socket readyness */
#include "lib/inet_pton.h" /* for IP addr SNI check */
#include "lib/curl_multibyte.h"
#include "lib/warnless.h"
