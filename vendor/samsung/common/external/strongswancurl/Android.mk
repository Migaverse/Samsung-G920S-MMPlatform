...
common_CFLAGS += -DHAVE_BORINGSSL -DOPENSSL_IS_BORINGSSL
LOCAL_C_INCLUDES += external/boringssl/include
LOCAL_SHARED_LIBRARIES := libz libssl libcrypto
else
LOCAL_C_INCLUDES += external/crypto-fips/include
LOCAL_SHARED_LIBRARIES := libz libfips_ssl libfips_crypto
endif
...
LOCAL_MODULE:= libstrongswancurl
